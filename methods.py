...
def buildAdPage(course_query):
	...
	<br><br> ניתן לגשת בכל עת למשרות שיצרתם באמצעות לחיצה על "המשרות שלי" בתפריט. שם תוכלו לצפות במשרות שיצרתם, לערוך אותן באמצעות לחיצה על "ערוך משרה" ולראות אילו סטודנטים מתאימים למשרה שהגדרתם באמצעות לחיצה על "הצג תוצאות".
 </p></div> """
